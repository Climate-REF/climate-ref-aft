...
It is off by default because a failing probe restarts the pod
and destroys whatever execution it was running,
...
while an execution is in progress and every busy worker would be restarted.
