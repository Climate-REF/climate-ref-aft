...
`scripts/smoke-test.sh` ingests sample data, runs a small solve across the three Fast Track providers,
and then hits the `ref-app` API to confirm the records the workers wrote are visible to the API.
