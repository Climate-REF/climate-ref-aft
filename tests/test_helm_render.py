...
def _render(
    *set_args: str, values: str | None = None, values_data: dict | None = None, chart: Path = CHART
...
def render(
    *set_args: str, values: str | None = None, values_data: dict | None = None, chart: Path = CHART
    ...
    result = _render(*set_args, values=values, values_data=values_data, chart=chart)
